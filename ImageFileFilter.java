...
public class ImageFileFilter extends FileFilter{
	/* This is amazingly close to the example given in the 'how to' section in java/
	   It's simply the only way of doing it and covers all file formats java can use, so it is sort of nickedish.
	 */
	...
	/**Returns true or false to indicate acceptance of the file.
		...
		@return true if the file given is acceptable input as an image, false if not
	*/
	public boolean accept(File f){
		...
		if(ext!=null)
			if(ext.equals("jpeg") || ext.equals("jpg") || ext.equals("png") || ext.equals("gif") || ext.equals("bmp"))
				return true;
	...
	*/
	public String getDescription(){
		return "Images only (.jpeg, .jpg, .png, .gif, .bmp)";
	}
